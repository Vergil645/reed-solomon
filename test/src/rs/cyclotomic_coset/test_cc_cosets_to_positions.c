...
static int test(const coset_t* cosets, uint16_t cosets_cnt, const uint16_t* positions,
    ...
    _positions = (uint16_t*)calloc(positions_cnt, sizeof(uint16_t));
    if (!_positions) {
    ...
    if (!util_u16_array_eq(_positions, (size_t)positions_cnt, positions, (size_t)positions_cnt)) {
...
int main(void) {
    ...
    // Test 4
    {
        ...
        uint16_t positions[] = {771,  1542, 3084,  6168,  12336, 24672, 49344, 33153, 1285,
                                2570, 5140, 10280, 20560, 41120, 16705, 33410, 30583, 61166};
