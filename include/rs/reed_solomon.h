...
/**
 * @brief Return code for cases when erases cannot be restored due to code parameters.
 */
 ...
 * @return 0 on success, 1 on memory allocation error, or RS_ERR_CANNOT_RESTORE.
 */
